...
namespace SZP.Core.DBHelp
{
    public class SQLServer : IDBAccessor
    {
        ...
        private static void StartTransaction(SqlCommand comm)
        {
            if (Transaction.transaction != null)
            {
                comm.Transaction = Transaction.transaction;
            }
        }
    ...
    public class Transaction : ITransaction
    {
        ...
        public bool IsTransaction
        {
            get {
                ...
                if (Transaction.transaction == null || Transaction.transaction.Connection == null)
                {
                    return false;
                }
                else
        ...
        {
            Transaction.transaction = ConnectionToSql.GetConnection().BeginTransaction();
        }
        /// <summary>
        /// 提交事务
        /// </summary>
