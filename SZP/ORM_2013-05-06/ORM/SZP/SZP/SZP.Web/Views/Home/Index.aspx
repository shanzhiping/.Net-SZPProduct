...
<body  class="easyui-layout" style="overflow-y: hidden" scroll="no">
    <noscript>
     ...
     <div region="north" split="true" border="false" style="overflow: hidden; height: 60px;
        ...
        <span style="float: right; padding-right: 20px;" class="head">欢迎 @Model.LogonUser.Name
                ...
                <ul>
                 ...
                 if (item.Children != null)
                 {
                     foreach (SZP.Entity.SysMenu items in item.Children)
                     {
                        ...
                        <li>
                         <div>
                            <a ref="1" rel="<% =items.PageUrl %>"><img src="<%=items.IconUrl %>" class="imgs" /><span class="nav"><% =items.Title%></span></a></div>
                         </li>                     
                      <% }
                 } %>                   
                </ul>
