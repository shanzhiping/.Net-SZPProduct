...
<table class="iList">
    ...
    <tbody id="tOperationBody">
        ...
        <tr>
            ...
            <td>
                <%-- <a href="javascript:void(0);" onclick="operationDetail('<%=item.Id %>')">
                    <img src="/Scripts/easyui/themes/default/SZP/images/detail.png" style="border: 0px;"
                        alt="查看" /></a> --%><a href="javascript:void(0);" onclick="operationEdit('<%=item.Id %>')">
...
<script type="text/javascript">
    ...
    function operationAdd() {
        ...
        openWinThis('/Views/SYS/Sysmenu/OperationAdd.aspx?meunId=<%=Request["parentId"] %>', 450, 410, '添加—' + meunName + '操作');
    }
